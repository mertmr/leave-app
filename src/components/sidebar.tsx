...
function Sidebar() {
  ...
  return (
    <div>
      ...
      {/* <div className={`hidden md:block bg-white text-gray-800 w-64 ${isSidebarOpen ? 'block' : 'hidden'} border-r-2 border-gray-300`}> */}
      <aside
        id="default-sidebar"
        className={`fixed left-0 top-0 z-40 h-screen w-64 ${isSidebarOpen ? 'block' : 'hidden'} `}
        aria-label="Sidebar"
      >
